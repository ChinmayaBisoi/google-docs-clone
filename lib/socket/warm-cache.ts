const STORAGE_KEY = "google-docs-clone-socket-warm-stamps";
export const MAX_STAMPS = 5;
/** Skip warm if we pinged within this window (socket stays warm a few minutes). */
 ...
 */
export function shouldWarmSocket(): boolean {
