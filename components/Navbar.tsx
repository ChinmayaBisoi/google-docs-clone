...
function SearchBar() {
	return (
		<div className="mx-auto flex h-12 max-w-[720px] flex-1 items-center justify-center gap-3 rounded-full bg-accent/50 px-4 transition-shadow focus-within:bg-background focus-within:shadow-md focus-within:ring-1 focus-within:ring-border">
